  ...
  return (
    <section id="project" className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto">See how I transformed concepts into engaging digitak experience</p>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  <div className="bg-gradient-to-r from-emerald-300 to-sky-400
                    inine-flex gap-2 font-bold uppercase tracking-widest text-sm
